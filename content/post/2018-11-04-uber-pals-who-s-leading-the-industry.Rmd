...
```{r pulling_data, echo = F, message=F, fig.width=12, fig.height=5}
...
```{r overall, echo = F, message=F, fig.width=12, warning=F}
...
```{r, compare_yellow, echo = F, message=F, fig.width=12, warning=F}
...
```{r extracting top players, echo=F, message=F, fig.width=12, warning=F}
#mark apps-------------------------------
df[,company:=ifelse(
...
```{r, echo=F, message=F, fig.width=12, warning=F}
